...
$query = "SELECT SUM(expamount) AS `expamount` FROM `exp_records` WHERE `exptype` = 'Credit' AND `exp_id_user` = '$user_id'";


// debit
$debit_query = "SELECT SUM(expamount) AS `expamount` FROM `exp_records` WHERE `exptype` = 'Debit' AND `exp_id_user` = '$user_id'";
